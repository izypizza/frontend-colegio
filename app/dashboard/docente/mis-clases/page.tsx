  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">Materias que impartes en el periodo actual</p>
      </div>
            ...
            <Card key={asignacion.id} className="hover:shadow-lg transition-shadow">
              ...
              <div className="space-y-2 mb-4">
                <div className="flex items-center text-sm text-gray-600">
                  ...
                  Código: <span className="font-semibold ml-1">{asignacion.materia.codigo}</span>
                </div>
                ...
                <div className="flex items-center text-sm text-gray-600">
                  ...
                  Periodo: <span className="font-semibold ml-1">{asignacion.periodo_academico.nombre}</span>
                </div>
              </div>
              ...
              <div className="space-y-2 pt-4 border-t">
                <Link
                  href={`/dashboard/docente/mis-estudiantes?seccion=${asignacion.seccion.id}`}
                ...
                <Link
                  href={`/dashboard/docente/registrar-asistencia?materia=${asignacion.materia.id}`}
                  className="flex items-center text-blue-600 hover:text-blue-700 font-medium text-sm group"
                >
                  <svg className="w-4 h-4 mr-2 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <Link
                  href={`/dashboard/docente/registrar-calificaciones?materia=${asignacion.materia.id}`}
                  className="flex items-center text-blue-600 hover:text-blue-700 font-medium text-sm group"
                >
                  <svg className="w-4 h-4 mr-2 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
