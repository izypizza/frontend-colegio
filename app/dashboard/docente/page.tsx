...
export default function DocenteDashboardPage() {
  ...
  const fetchDashboard = async () => {
    try {
      ...
      const response = await docentePortalService.misAsignaciones() as { asignaciones?: any[] };
      ...
      const mockData: DashboardData = {
        resumen: {
          ...
          porcentaje_asistencia: parseFloat((Math.random() * 10 + 85).toFixed(1))
        },
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">Vista general de tus clases y estudiantes</p>
      </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-3xl font-bold mt-2 ${
                (data?.resumen.porcentaje_asistencia || 0) >= 80 ? 'text-green-600' : 'text-orange-600'
              }`}>
            ...
            <div className={`w-14 h-14 rounded-full flex items-center justify-center ${
              (data?.resumen.porcentaje_asistencia || 0) >= 80 ? 'bg-green-100' : 'bg-orange-100'
            }`}>
      ...
      <Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div>
              <h3 className="font-semibold text-gray-900 group-hover:text-blue-700">Ver Mis Clases</h3>
          ...
          >
            ...
            <div>
              <h3 className="font-semibold text-gray-900 group-hover:text-green-700">Mis Estudiantes</h3>
          ...
          >
            ...
            <div>
              <h3 className="font-semibold text-gray-900 group-hover:text-purple-700">Calificaciones</h3>
        ...
        {data?.asignaciones && data.asignaciones.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {data.asignaciones.slice(0, 6).map((asignacion: any) => (
              <div key={asignacion.id} className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                <h3 className="font-semibold text-gray-900 mb-2">{asignacion.materia.nombre}</h3>
                <p className="text-sm text-gray-600 mb-2">
                  {asignacion.seccion.grado.nombre} - {asignacion.seccion.nombre}
                </p>
                <div className="flex items-center justify-between">
          ...
          <p className="text-center text-gray-500 py-8">No tienes clases asignadas</p>
        )}
        ...
        <Card>
          ...
          <div className="space-y-3">
            <div className="flex items-start p-3 bg-yellow-50 border-l-4 border-yellow-400 rounded">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Calificaciones pendientes</p>
                <p className="text-xs text-gray-600 mt-1">Registra las notas del último bimestre</p>
              </div>
            </div>
            <div className="flex items-start p-3 bg-blue-50 border-l-4 border-blue-400 rounded">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Asistencia de hoy</p>
                <p className="text-xs text-gray-600 mt-1">No olvides tomar asistencia en todas tus clases</p>
              </div>
            </div>
          </div>
        </Card>
        ...
        <Card>
          ...
          <div className="space-y-3">
            <div className="flex items-start p-3 bg-green-50 rounded">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Usa la vista de gráficas</p>
                <p className="text-xs text-gray-600 mt-1">Analiza el rendimiento de tus estudiantes visualmente</p>
              </div>
            </div>
            <div className="flex items-start p-3 bg-purple-50 rounded">
              <svg className="w-5 h-5 text-purple-600 mt-0.5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
              <div>
                <p className="text-sm font-medium text-gray-900">Registra observaciones</p>
                <p className="text-xs text-gray-600 mt-1">Agrega comentarios para un mejor seguimiento</p>
              </div>
            </div>
          </div>
        </Card>
